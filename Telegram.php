...
class Telegram extends \yii\base\Component
{
    ...
    public function init()
    {
        ...
        $this->apiEndpoint = $this->apiEndpoint ?: 'https://api.telegram.org';
    }
    ...
    {
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/getMe");
        return $jsonResponse;
    }
    ...
    public function sendMessage(array $option)
    {
        ...
        unset($option['text']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/sendMessage?chat_id=" . $chat_id
            . '&text=' . $text, $option);
    ...
    public function forwardMessage(array $option)
    {
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/forwardMessage?chat_id=" . $chat_id, $option);
        return json_decode($jsonResponse);
    }
    ...
    public function sendPhoto(array $option)
    {
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" .
    ...
    public function sendAudio(array $option)
    {
        ...
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/sendAudio?chat_id=" . $chat_id .
    ...
    public function sendDocument(array $option)
    {
        ...
        unset($option['chat_id']);
        unset($option['caption']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/sendDocument?chat_id=" . $chat_id
            . '&caption=' . $caption, $option);
        return json_decode($jsonResponse);
    }
    ...
    public function sendSticker(array $option)
    {
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/sendSticker?chat_id=" . $chat_id, $option);
        return json_decode($jsonResponse);
    }
    ...
    public function sendVideo(array $option)
    {
        ...
        unset($option['chat_id']);
        unset($option['caption']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken .
    ...
    public function sendLocation(array $option)
    {
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/sendLocation?chat_id=" . $chat_id, $option);
        return json_decode($jsonResponse);
    }
    ...
    public function sendChatAction(array $option)
    {
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/sendChatAction?chat_id=" . $chat_id, $option);
        return json_decode($jsonResponse);
    }
    ...
    public function getUserProfilePhotos($option)
    {
        ...
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/getUserProfilePhotos?user_id=" . $user_id, $option);
        return json_decode($jsonResponse);
    }
    ...
    {
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/getUpdates", $option);
        return json_decode($jsonResponse);
    }
    ...
    {
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/setWebhook", $option);
        return json_decode($jsonResponse);
    }
    ...
    {
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/getChat", $option);
        return json_decode($jsonResponse);
    }
    ...
    {
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/getChatAdministrators", $option);
        return json_decode($jsonResponse);
    }
    ...
    {
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/getChatMembersCount", $option);
        return json_decode($jsonResponse);
    }
    ...
    {
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/getChatMember", $option);
        return json_decode($jsonResponse);
    }
    ...
    {
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/answerCallbackQuery", $option);
        return json_decode($jsonResponse);
    }
    ...
    {
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/editMessageText", $option);
        return json_decode($jsonResponse);
    }
    ...
    {
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/editMessageCaption", $option);
        return json_decode($jsonResponse);
    }
    ...
    {
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/sendGame", $option);
        return json_decode($jsonResponse);
    }
    ...
    {
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/Game", $option);
        return json_decode($jsonResponse);
    }
    ...
    {
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/Animation", $option);
        return json_decode($jsonResponse);
    }
    ...
    {
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/CallbackGame", $option);
        return json_decode($jsonResponse);
    }
    ...
    {
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/getGameHighScores", $option);
        return json_decode($jsonResponse);
    }
    ...
    {
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/GameHighScore", $option);
        return json_decode($jsonResponse);
    }
    ...
    {
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/answerInlineQuery", $option);
        return json_decode($jsonResponse);
    }
    ...
    public function kickChatMember(array $option = [])
    {
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/kickChatMember?chat_id=" . $chat_id, $option);
        return json_decode($jsonResponse);
    }
    ...
    public function restrictChatMember(array $option = [])
    {
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/restrictChatMember?chat_id=" . $chat_id, $option);
        return json_decode($jsonResponse);
    }
    ...
    public function promoteChatMember(array $option = [])
    {
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/promoteChatMember?chat_id=" . $chat_id, $option);
        return json_decode($jsonResponse);
    }
    ...
    public function exportChatInviteLink(array $option = [])
    {
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/exportChatInviteLink?chat_id=" . $chat_id, $option);
        return json_decode($jsonResponse);
    }
    ...
    public function deleteChatPhoto(array $option = [])
    {
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/deleteChatPhoto?chat_id=" . $chat_id, $option);
        return json_decode($jsonResponse);
    }
    ...
    public function setChatTitle(array $option = [])
    {
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/setChatTitle?chat_id=" . $chat_id, $option);
        return json_decode($jsonResponse);
    }
    ...
    public function setChatDescription(array $option = [])
    {
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/setChatDescription?chat_id=" . $chat_id, $option);
        return json_decode($jsonResponse);
    }
    ...
    public function unpinChatMessage(array $option = [])
    {
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/unpinChatMessage?chat_id=" . $chat_id, $option);
        return json_decode($jsonResponse);
    }
    ...
    public function pinChatMessage(array $option = [])
    {
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/pinChatMessage?chat_id=" . $chat_id, $option);
        return json_decode($jsonResponse);
    }
    ...
    public function leaveChat(array $option = [])
    {
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/leaveChat?chat_id=" . $chat_id, $option);
        return json_decode($jsonResponse);
    }
    ...
    public function setChatStickerSet(array $option = [])
    {
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/setChatStickerSet?chat_id=" . $chat_id, $option);
        return json_decode($jsonResponse);
    }
    ...
    public function deleteChatStickerSet(array $option = [])
    {
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiEndpoint . "/bot" . $this->botToken . "/deleteChatStickerSet?chat_id=" . $chat_id, $option);
        return json_decode($jsonResponse);
    }
